                        ...
                        <table className='table align-middle gs-0 gy-4'>
                            ...
                            <thead>
                                <tr className='fw-bold text-muted bg-light'>
                                    ...
                                    <th className='min-w-100px'>Intutile</th>
                                    <th className='min-w-100px'>Souche</th>
                                    <th className='min-w-100px'>Transforme</th>
                                    <th className='min-w-150px'>Notification par mail</th>
                                    <th className='min-w-100px'>E-mail</th>
                                    <th className='min-w-100px'>Desactive</th>
                                    <th className='min-w-100px'>Logistique</th>
                                    <th className='min-w-100px'>Validation</th>
